...
Working with AI-powered products, like any other product, has an associated mental model from its users. HCAI solutions should work within existing mental models and set expectations on what it can and cannot confidently perform in order to build appropriate levels of trust. Capabilities of the technology will evolve over time—as will expectations—so an evolving framework is required to monitor and adapt solutions to mold to changing mental models.