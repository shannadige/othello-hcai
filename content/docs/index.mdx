...
<div style={{ margin: '24px 0'}}>
  <Banner changeLayout={false}>
    ⚠️ Othello Docs is still under construction. To contribute, please visit the repository linked above and send feedback to our authoring team.
  </Banner>
</div>
...
<Cards>
  ...
  <Card title="Learn more about Fumadocs" href="https://fumadocs.vercel.app" icon={<Book className="!w-8 !h-8" />} className="[&_[role=img]]:!bg-transparent [&_[role=img]]:!border-0" />
</Cards>
